...
def generate_combinations(
    ...
    cash_penalty_proportion_list: list,
    upside_pnl_multiplier_list: list,
    stoploss_min_list: list,
    stoploss_max_list: list,
    n_steps_list: list,
    ent_coef_list: list,
    ...
    for (
        ...
        cash_penalty_proportion_list,
        upside_pnl_multiplier_list,
        stoploss_min_list,
        stoploss_max_list,
        n_steps_list,
        ent_coef_list,
        ...
        combos.append({
            ...
            "cash_penalty_proportion": cash_pen,
            "upside_pnl_multiplier": up_mult,
            "stoploss_min": sl_min,
            "stoploss_max": sl_max,
            "n_steps": n_st,
            "ent_coef": ent,
...
def build_commands(combo: dict, work_dir: str, use_local_history: bool = False, local_history_dir: str = "./history") -> list[list[str]]:
    ...
    cmds.append([
        ...
        "--cash_penalty", str(combo["cash_penalty_proportion"]),
        "--upside_pnl_multiplier", str(combo["upside_pnl_multiplier"]),
        "--stoploss_min", str(combo["stoploss_min"]),
        "--stoploss_max", str(combo["stoploss_max"]),
    ])
...
def append_result_row(
    ...
    with open(output_path, "a", newline="") as f:
        ...
        row = [
            ...
            combo["cash_penalty_proportion"], combo["upside_pnl_multiplier"],
            combo["stoploss_min"], combo["stoploss_max"],
...
def main():
    ...
    combos = generate_combinations(
        ...
        cash_penalty_proportion_list=config.get("cash_penalty_list", [0.0]),
        upside_pnl_multiplier_list=config.get("upside_pnl_multiplier_list", [1.25]),
        stoploss_min_list=config.get("stoploss_min_list", [0.75]),
        stoploss_max_list=config.get("stoploss_max_list", [1.0]),
